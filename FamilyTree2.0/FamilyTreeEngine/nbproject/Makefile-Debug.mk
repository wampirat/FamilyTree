...
${OBJECTDIR}/PeopleCollection.o: PeopleCollection.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeopleCollection.o PeopleCollection.cpp
...
${TESTDIR}/FamilyTest.o: FamilyTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../../gtest-1.7.0/include -I../../../../../gtest-1.7.0 -I. -I. std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/FamilyTest.o FamilyTest.cpp


${TESTDIR}/FamilyTreeFrameworkTest.o: FamilyTreeFrameworkTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../../gtest-1.7.0/include -I../../../../../gtest-1.7.0 -I. -I. std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/FamilyTreeFrameworkTest.o FamilyTreeFrameworkTest.cpp


${TESTDIR}/PeopleCollectionTest.o: PeopleCollectionTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../../gtest-1.7.0/include -I../../../../../gtest-1.7.0 -I. -I. std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/PeopleCollectionTest.o PeopleCollectionTest.cpp


${TESTDIR}/PersonTest.o: PersonTest.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../../gtest-1.7.0/include -I../../../../../gtest-1.7.0 -I. -I. std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/PersonTest.o PersonTest.cpp


${TESTDIR}/ScenarioTests.o: ScenarioTests.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../../gtest-1.7.0/include -I../../../../../gtest-1.7.0 -I. -I. std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/ScenarioTests.o ScenarioTests.cpp
...
${OBJECTDIR}/Family_nomain.o: ${OBJECTDIR}/Family.o Family.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Family_nomain.o Family.cpp;\
	else  \
...
${OBJECTDIR}/PeopleCollection_nomain.o: ${OBJECTDIR}/PeopleCollection.o PeopleCollection.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PeopleCollection_nomain.o PeopleCollection.cpp;\
	else  \
...
${OBJECTDIR}/Person_nomain.o: ${OBJECTDIR}/Person.o Person.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Person_nomain.o Person.cpp;\
	else  \
